...
public class PDFFragment extends Fragment   {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.pdf_view_layout, container, false);
    }
    ...
    public void onStart() {
        ...
        String pdfname = MainActivity.mPDF_Name;
        if (MainActivity.cryptEnabled)
        {
            FileOp fOps = new FileOp();
            fOps.doDecrypt(this.getActivity(), MainActivity.mPDF_Name);
            pdfname  = "decr"+MainActivity.mPDF_Name;
            Toast.makeText(this.getContext(), "Reading from Decrypted" , Toast.LENGTH_LONG).show();
            File file = new File(this.getActivity().getFilesDir(), pdfname);
